import hackathonGallery from "../data/Fall2025Gallery.json";
import '../styles/Global.css'; 
import '../styles/Hackathon.css';
import { useEffect, useState } from "react";


const Fall2025HackathonGallery = () => {
    return (
        <>
        <Gallery />
        </>
...
const Gallery = () => {
    ...
    return (
        <section className="hackathon-gallery-section section-purple">
            <h2 className="hackathon-gallery-h2 page-h2 color-green"> ₊˚✧ ━━━━⊱ Fall 2025 Harmony Hackathon Gallery ⊰━━━━ ✧₊˚ </h2>
...
export default Fall2025HackathonGallery;